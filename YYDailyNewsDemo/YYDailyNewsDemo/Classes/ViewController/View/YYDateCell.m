...
- (void)configUI{
    ...
    _bgImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 40.f)];
    _bgImgView.image = Image(@"navBar");
    _bgImgView.autoresizingMask = UIViewAutoresizingFlexibleWidth;
    [self addSubview:_bgImgView];
    
    _dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth/2-100.f, 8.f, 200.f, 24.f)];
