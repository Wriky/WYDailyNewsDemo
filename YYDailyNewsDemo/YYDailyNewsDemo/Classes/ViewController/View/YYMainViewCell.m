...
- (void)configUI{
    ...
    _newsImageView = [[UIImageView alloc] initWithFrame:CGRectMake(ScreenWidth - 60.f, 10.f, 50.f, 50.f)];
    [self.contentView addSubview:_newsImageView];
    
    _newsTitleLbl = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 6.f, ScreenWidth-90.f, 60.f)];
